\documentclass[10pt,journal,onecolumn]{article}
...
\subsection{Activation Capture and Direction Extraction}
...
\subsection{Probing and Causal Necessity}
...
% =========================================================================
\section{The Sharpness Confound and Cross-Regime Dynamics}
...
\subsection{Defining the Confound}
...
\subsection{Resolution via Scale-Invariant Metrics}
...
% =========================================================================
\section{The 2D Rotational Sweep and Local Perturbation Dynamics}
...
\subsection{Theoretical Boundary: Low-Precision 1-bit Transformer Environments}
...
% =========================================================================
\section{Topological Phase Transitions and Attractor Stability}
...
\subsection{Topological Data Analysis --- Single-Shot Pre-fill Phase Surgery (SPPS)}
...
\subsection{Key Findings: Gemma 3 4b-it}
...
\subsection{Scalability: Future Extensions to Larger Architectures (Gemma 4)}
...
\subsection{Transition and Resilience Visualizations}
\label{sec:visualizations}

\paragraph{Transition Curves (Sensitivity of Phase):}
...
\paragraph{Polar Resilience Signature:}
...
\subsection{$H_1$ Persistence Barcodes ($K=0$, SPPS)}
\label{sec:barcodes}
...
% =========================================================================
\section{Weight Amortization via CASAL}
...
\subsection{Methodology and Loss Formulation}
...
\subsection{Training Convergence and Validation}
...
\subsection{Alternative Alignments: Connection to Inoculation Prompting}
...
% =========================================================================
\section{Revised Conclusions and Discussion}
